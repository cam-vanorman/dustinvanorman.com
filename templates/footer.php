	<footer id="contact" class="content-info" role="contentinfo">
		<div class="container-fluid">
			<section class="copyright-2015">
				<div class="row text-center">
					<div class="col-xs-12">
						<ul class="list-inline">
							<li><a class="btn-social btn-outline" href="//www.linkedin.com/in/dustinvanorman" target="_blank"><i class="fab fab-linkedin-alt bt-fw"></i></a></li>
						...
						<p class="text-center">Made with brotherly <i title="love" class="love btl bt-heart bt-fw"></i> &amp; <i title="coffee" class="btl bt-mug bt-fw"></i> by <a class="text-light-green" href="//vanorman.design" target="_blank">Cameron Van Orman</a> in Seattle, WA.</p>

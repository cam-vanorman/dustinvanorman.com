            ...
            <div class="row">
                <div class="col-lg-10 col-lg-offset-1">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="service-item">
                                <h3>The effects of acute aerobic exercise on auditory/spoken language</h3>
                                <h4>Van Orman, D.S.J. (In preparation).</h4>
                        ...
                        <div class="col-sm-6">
                            <div class="service-item">
                                <h3>Assessing 'learning' across three communication mediums: A mixed methods approach</h3>
                                <h4>Van Orman, D.S.J. (In preparation).</h4>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <h3>A sociolinguistic review of language attitude research in four Chinese cities</h3>
                            <h4>Van Orman, D.S.J. (In preparation).</h4>
                        ...
                        <div class="col-sm-6">
                            <h3>A case study assessing a Chinese high school's students' perceptions of linguistic, acculturative, psychological and sociocultural issues when studying abroad in the United States.</h3>
                            <h4>Wang, H. and Van Orman, D.S.J. (In preparation).</h4>

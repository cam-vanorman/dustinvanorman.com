            ...
            <div class="row">
                <div class="col-lg-10 col-lg-offset-1">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="service-item">
                                <h4>Van Orman, D.S.J. (In preparation). ‘The effects of acute aerobic exercise on auditory/spoken language</h4>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="service-item">
                                <h4>Van Orman, D.S.J. (In preparation). ‘Assessing ‘learning’ across three communication mediums: A mixed methods approach’.</h4>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <h4>Van Orman, D.S.J. (In preparation). ‘A sociolinguistic review of language attitude research in four Chinese cities’.</h4>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <h4>Wang, H. and Van Orman, D.S.J. (In preparation). ‘A case study assessing a Chinese high school’s students’ perceptions of linguistic, acculturative, psychological and sociocultural issues when studying abroad in the United States’.</h4>
